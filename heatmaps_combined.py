...
figs, ax = plt.subplots(2,1, sharex = True)
...
heatmap = ax[0].imshow(vx_data, cmap = cmap, norm = norm, aspect = 2)
#ax[0].set_xlabel(r'$F_p$', rotation = 0 )
ax[0].set_xticks(ticks = j_array, labels = fp_labels)
ax[0].set_ylabel(r'$\rho$', rotation = 0 )
ax[0].set_yticks(ticks = i_array, labels = rho_labels)
colorbar = plt.colorbar(heatmap, shrink = 0.8, aspect = 8)
colorbar.ax.set_title(r'$v_x$', pad = 10)

ax[0].add_patch(Rectangle((0.1,-0.25),2.1,1.1,facecolor = 'white',fill = True, edgecolor='black', lw = 0.5))
ax[0].text(0.2,0.6,"a)",color='black',fontsize = 15)
...
heatmap2 = ax[1].imshow(vy_data, cmap = cmap, norm = norm, aspect = 2)
ax[1].set_xlabel(r'$F_p$', rotation = 0 )
ax[1].set_xticks(ticks = j_array, labels = fp_labels)
ax[1].set_ylabel(r'$\rho$', rotation = 0 )
ax[1].set_yticks(ticks = i_array, labels = rho_labels)
colorbar = plt.colorbar(heatmap2, shrink = 0.8, aspect = 8)
colorbar.ax.set_title(r'$v_y$', pad = 10)

ax[1].add_patch(Rectangle((0.1,-0.25),2.1,1.1,facecolor = 'white',fill = True, edgecolor='black', lw = 0.5))
ax[1].text(0.2,0.6,"b)",color='black',fontsize = 15)
